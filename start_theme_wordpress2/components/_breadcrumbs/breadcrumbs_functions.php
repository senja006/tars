...
$components_acf[] = array(
	...
	'sub_fields' => array(
		array(
			'key'               => 'field_57e2a4ee0f939',
			'label'             => 'Только начало и конец',
			'name'              => 'is_only_start_end',
			'type'              => 'true_false',
			'instructions'      => '',
			'required'          => 0,
			'conditional_logic' => 0,
		...
		array(
			'key'               => 'field_57e296e1b8b29',
			'label'             => 'Добавить отступ слева',
			'name'              => 'margin_left_as_width_sidebar',
			'type'              => 'true_false',
			'instructions'      => '',
			'required'          => 0,
			'conditional_logic' => 0,
